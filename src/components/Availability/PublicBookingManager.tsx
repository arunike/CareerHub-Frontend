...
import BulkActionHeader from '../actions/BulkActionHeader';
import SelectionCheckbox from '../inputs/SelectionCheckbox';
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] gap-5">
      ...
      <BookingsPanel
        ...
        handleBulkToggleLockBookings={handleBulkToggleLockBookings}
        handleSelectAllBookings={handleSelectAllBookings}
        handleSelectBooking={handleSelectBooking}
        isAnyBookingLocked={isAnyBookingLocked}
