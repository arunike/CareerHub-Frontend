...
import CompensationFields, { type CompValue } from '../inputs/CompensationFields';
...
import { parseResumeExperience } from '../../utils/Experience/experienceResumeParse';
import { useExperienceFormSync } from '../../hooks/Experience/useExperienceFormSync';
