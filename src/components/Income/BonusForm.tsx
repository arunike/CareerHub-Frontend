...
import type { IncomeEvent } from '../../utils/Income/tax/ledger';
import type { PayPeriod } from '../../utils/Income/paySchedule';
...
import {
  ...
  type BonusExtra,
  type BonusPayout,
} from '../../utils/Income/bonusSchedule';
import SegmentedToggle from '../inputs/SegmentedToggle';
import FigureMath from './FigureMath';
import { bonusBreakdown } from '../../utils/Income/mathBreakdown';
