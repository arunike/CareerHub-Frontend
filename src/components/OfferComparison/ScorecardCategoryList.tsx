import { type ApplicationLike as Application } from '../../utils/OfferComparison/calculations';
...
} from '../../utils/OfferComparison/immigrationSignal';
import AccessibleStarRating from './AccessibleStarRating';
import HelpTooltipTrigger from '../feedback/HelpTooltipTrigger';
import { clamp, normalizeManualScore } from '../../utils/OfferComparison/decisionScoring';
...
const ScorecardCategoryList = ({
  ...
  <div className="@container">
    <div className="grid gap-x-6 gap-y-5 @[22rem]:grid-cols-2">
          ...
          const pairs = [
            {
              dbKey: 'growth_score',
              label: 'Growth',
              tooltip: DECISION_SIGNAL_TOOLTIPS.growthScore,
            },
          ...
          return (
            <div key={category.key} className="flex flex-col">
              ...
              <div className="space-y-1.5">
                {pairs.map((pair) => (
                  <div key={pair.dbKey} className="flex flex-wrap items-center gap-x-3 gap-y-0.5">
                    <HelpTooltipTrigger
                      title={pair.tooltip}
