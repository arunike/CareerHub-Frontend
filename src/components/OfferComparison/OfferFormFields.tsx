...
import type { MealEntry } from '../../utils/OfferComparison/freeFood';
...
import type { EquityLiquidity } from '../../utils/OfferComparison/equityLiquidity';
import {
  ...
  type TaxRatePreview,
} from '../../utils/OfferComparison/sections';
          ...
          >
            ...
            >
              <TimeOffSection
                ...
                unlimitedPtoPlanningDays={unlimitedPtoPlanningDays}
                onUnlimitedPtoPlanningDaysChange={onUnlimitedPtoPlanningDaysChange}
              />
            </OfferFormSection>
          </div>
