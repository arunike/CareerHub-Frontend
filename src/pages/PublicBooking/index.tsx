      ...
      <div className="min-h-screen bg-gray-50 p-4 sm:p-8">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <p className="text-gray-600">
            This link is invalid or expired. Please ask for a new booking link.
          </p>
        </div>
      </div>
    );
        ...
        <div className="relative overflow-hidden rounded-[32px] bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-12">
              ...
              <div className="bg-slate-50 rounded-[24px] p-6 border border-slate-100 min-w-[240px]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {hostEmail && (
                      <div className="text-xs text-slate-400 font-medium">{hostEmail}</div>
                    )}
                  </div>
                </div>
          ...
          {publicNote && (
            <div className="mt-10 p-5 rounded-2xl bg-sky-50/50 border border-sky-100 text-slate-700 text-sm leading-relaxed relative">
              <div className="absolute top-0 left-6 -mt-2.5 px-2 bg-sky-100 text-sky-600 text-[9px] font-black uppercase tracking-wider rounded">
                Note
              </div>
              {publicNote}
            </div>
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {days.map((day) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`text-[9px] font-black uppercase mb-1 ${isSelected ? 'text-blue-100' : 'text-slate-400'}`}
                            >
