        ...
        <div className="flex flex-wrap items-center gap-0.5 border-b border-slate-100 px-3 py-2">
          ...
          >
            <svg viewBox="0 0 16 16" width="14" height="14" fill="currentColor">
              <path
                fillRule="evenodd"
                d="M2 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3.5-1.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 4a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zM2 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"
              />
            </svg>
          </ToolbarButton>
          <ToolbarButton
