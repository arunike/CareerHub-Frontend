        ...
        <div className="min-w-0 flex-1">
          ...
          {isEditing ? (
            <div className="mt-2 flex min-w-0 flex-col gap-2 sm:flex-row">
              <input
                className="min-h-11 min-w-0 flex-1 rounded border border-gray-300 px-3 py-2 font-mono text-sm outline-none focus:ring-2 focus:ring-blue-500"
                value={editText}
            ...
            <div className="group/text flex min-w-0 items-center gap-2">
              <p className="min-w-0 break-words font-mono text-sm font-medium text-gray-700 [overflow-wrap:anywhere] md:text-base">
                {item.availability}
              </p>
              {item.date && (
                <button
