...
import type { MaritalStatus, SimulatedOffer } from '../../utils/OfferComparison/calculations';
import type { SavedOfferAdjustmentSettings } from '../../utils/OfferComparison/offerAdjustmentsTypes';
